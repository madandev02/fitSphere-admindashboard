...
const activities = [
  ...
  },
  {
    ...
    bgColor: "bg-emerald-100 dark:bg-blue-900/30",
  },
  {
    id: 3,
    type: "payment",
    ...
    description: "Payment of $1,200 completed",
    time: "12 minutes ago",
  ...
  },
  {
    ...
    description: "Multivitamin 30 Capsules stock is slow",
    time: "2 hours ago",
    color: "text-red-500",
...
function ActivityFeed() {
  return (
    <div
      className="bg-white/80 dark:bg-slate-900/50 backdrop-blur-xl rounded-2xl border
            ...
            dark-hover:bg-slate-800/50 transition-colors"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-slate-600 dar:text-slate-400 truncate">
