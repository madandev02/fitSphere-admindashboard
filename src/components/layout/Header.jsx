      ...
      <div className="flex items-center justify-between">
        ...
        dark:hover:bg-slate-800 transition-colors" onClick={onToggleSideBar}>
          ...
          <div className="hidden md:block">
            ...
            <p className="text-medium text-slate-800 dark:text-white">
              Welcome back, MaDanDev! Here's what's happening today
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          {/* Quick Action */}
          <button
            className="hidden lg:flex items-center space-x-2 py-2 px-4 bg-gradient-to-r from-blue-500 to-green-600
          ...
          >
            <img
              src="https://avatars.githubusercontent.com/u/164057252?v=4"
              alt="User"
